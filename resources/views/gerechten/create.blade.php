...
@section('content')
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-8">
                    <h1 class="text-3xl font-bold text-gray-900 mb-8">Nieuw recept toevoegen</h1>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="number" name="bereidingstijd_minuten" id="bereidingstijd_minuten"
                                           min="1" value="{{ old('bereidingstijd_minuten') }}"
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="bereidingswijze" id="bereidingswijze" rows="8"
                                              ...
                                              placeholder="Beschrijf de bereidingswijze stap voor stap...">{{ old('bereidingswijze') }}</textarea>
                                </div>
                            </div>
                        </div>
    ...
    <!-- JavaScript voor dynamische ingrediënten -->
    <script>
        document.getElementById('add-ingredient').addEventListener('click', function() {
            ...
            row.className = 'grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-white rounded-lg border border-gray-200';
